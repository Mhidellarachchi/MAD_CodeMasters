...
public class DbHandler extends SQLiteOpenHelper {
    ...
    public void addToDo(ToDo toDo){
        ...
        contentValues.put(PHONE,toDo.getPhone());
    ...
    public List<ToDo> getAllToDos(){
        ...
        if(cursor.moveToFirst()){
            do {
                ...
                toDo.setPhone(cursor.getString(2));
    ...
    public ToDo getSingleToDo(int id){
        ...
        Cursor cursor = db.query(TABLE_NAME,new String[]{ID,TITLE,PHONE,DESCRIPTION,STARTED, FINISHED},
